...
function private __init__()
{
	...
	level.var_6cb314b1 = array(#"hash_18e6f0326e75bce4", #"hash_23c6d9e19274be66", #"hash_a1deb882d59a069", #"acog_wz_item", #"dualoptic_wz_item", #"holo_wz_item", #"reflex_wz_item", #"hash_559f58d5af0b432d", #"hash_460aadea32c22c61", #"hash_2a10ad247a663aaa", #"hash_43b78d5eff27f2f7", #"extmag_wz_item", #"hash_513a787ad3a20198", #"hash_38821d90f8209d05", #"hash_43d8944b55b1e63c", #"hash_7bdf38527a146679", #"stock_wz_item");
...
function private function_9160538(localclientnum, eventtype, eventdata, var_c5a66313, var_567004a8)
{
	...
	switch(eventtype)
	{
		...
		case 4:
		{
			...
			item_inventory::function_9c4460e0(localclientnum, var_d8138db2, count, slotid);
			function_b78a9820(localclientnum);
			break;
		}
		case 11:
...
function private function_4e9220ab(localclientnum, oldval, newval, bnewent, binitialsnap, fieldname, bwastimejump)
{
	if(newval)
	{
		...
		foreach(var_bd027dd9, var_ee7a9894 in clientdata.var_ffc1c0e1)
		{
			clientdata.var_ffc1c0e1[var_bd027dd9].servertime = 0;
		}
		foreach(var_7b9b4259, var_ee7a9894 in clientdata.var_baf65690)
		{
...
function private function_1b42632a(localclientnum, clientdata, var_2ccf7a1c)
{
	...
	foreach(var_7d6cdf6f, var_ee7a9894 in clientdata.var_ffc1c0e1)
	{
