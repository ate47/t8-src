...
function function_ee93e2d4(weapon, source_player)
{
	if(!(isdefined(self.revived) && self.revived))
	{
		...
		if(var_a9b02eaa)
		{
			...
			{
				source_player thread namespace_73e1c3e3::function_d471f8fa(10, undefined, 1);
				self.var_6722b63 = 1;
			}
			self.b_revived = 1;
			self.var_3c5a5d29 = 2;
...
function function_587088a0()
{
	...
	if(level.var_1102e61.size > 0)
	{
		...
		self namespace_73e1c3e3::objcounter_init(undefined, 0, level.var_9e8e503f, 1, 1);
	...
	while(true)
	{
		...
		if(isdefined(n_start_time))
		{
			...
			if(dt >= 40)
			{
				...
				e_player namespace_73e1c3e3::objcounter_init(undefined, n_count, level.var_9e8e503f, 1, 1);
				break;
			}
		}
