...
function function_d27e566()
{
	...
	level notify(#"colbounds_tut_4_5_doorway_on");
	waitframe(1);
	level.var_7cab580 = ct_utils::function_d153452e(#"prt_mp_engineer");
	level.select_character = ct_utils::function_d153452e(#"prt_mp_engineer");
...
function function_9c64562d(_hash)
{
	...
	level.var_6c7517de ct_bots::function_991ccf1a();
}
...
function function_b17df12a()
{
	...
	var_a4b595d7 thread ct_vo::function_5c6cfeda("vox_tvoi_tutor_torq_smrt_cvr_dmg_nag");
	var_f2f6bc54 thread ct_vo::function_5c6cfeda("vox_tvoi_tutor_torq_razor_wire_dmg_nag");
	...
	do
	{
		if(!self flag::get("fixate_on_player"))
		{
			...
			if(var_653c2dd8 != #"sniper_powerbolt_t8" && !isbot(self.e_target))
			{
				...
				{
					if(self canpath(self.origin, self.e_target.origin))
					{
						self ct_utils::function_4caeacf6();
						self.var_38b6161f = 1;
					}
...
/*
	...
	Flags: None
*/
function function_5c6cfeda(str_vo, var_f4b1cabb = 1, n_rest = 10, var_515667fb = #"axis", str_mod, str_weapon)
{
	level endon(#"combattraining_logic_finished");
	self endon(#"death");
	e_player = ct_utils::get_player();
...
function function_344aee09(_hash)
{
	...
	if(!(isdefined(level.var_29324553) && level.var_29324553))
	{
		...
		if(_hash == #"death")
		{
			...
			{
				if(level.var_8ca3c62 === 6 || level.var_8ca3c62 === 7)
				{
					e_player ct_vo::function_c72e58c1(#"died");
...
function function_a20738a(var_fd986e47 = 0)
{
	...
	self.var_ef59b90 = 6;
	self.var_41f5536a = 1;
	self thread _enemy_razorwire_flounder(var_ffd337e1);
	self thread ct_utils::function_1746776e();
...
/*
	Name: _enemy_razorwire_flounder
	Namespace: ct_torque_tutorial
	Checksum: 0xF37912B0
	Offset: 0xB1B8
	Size: 0x398
...
function _enemy_razorwire_flounder(e_inflictor)
{
	...
	if(isalive(e_inflictor))
	{
		...
		s_flounder = arraygetclosest(self.origin, var_a273f861);
		var_82eec69f = 0;
		var_9af37af8 = 1.5;
		var_bb87b2bc = 2;
		var_5c3e2c40 = 6;
