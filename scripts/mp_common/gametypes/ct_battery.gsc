...
function function_9e8fddfe()
{
	...
	e_player = namespace_73e1c3e3::get_player();
	e_player namespace_73e1c3e3::objcounter_init(#"hash_1b6372a0a5dc0fef", 0, level.var_11f15cb8.size, 1, 1);
}
...
/*
	Name: registerstart_killstreak_collision_rounds
	Namespace: ct_battery
	Checksum: 0x9F12BD01
	Offset: 0x1250
	Size: 0xA2
	...
	while(true)
	{
		if(isdefined(self.primarytarget))
		{
			...
			while(isdefined(self.turrettarget) && isalive(self.turrettarget))
			{
				...
				self notify(#"turret reloading", self.pilotistalking);
...
function private function_1f04fda(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, vdamageorigin, psoffsettime, damagefromunderneath, modelindex, partname, vsurfacenormal)
{
	...
	{
		if(smeansofdeath !== "MOD_IMPACT" && weapon === w_cluster)
		{
			self.damagetaken = self.damagetaken + 1501;
		}
...
function function_701302a8()
{
	...
	e_player namespace_73e1c3e3::objcounter_init(#"hash_1b6372a0a5dc0fef", 0, level.var_ae0bbaac.size, 1, 1);
...
function function_56e0d37e(var_764a1fa0)
{
	...
	namespace_73e1c3e3::get_player() namespace_73e1c3e3::objcounter_init(#"hash_1b6372a0a5dc0fef", 0, level.var_4d4de8f9.size, 1, 1);
