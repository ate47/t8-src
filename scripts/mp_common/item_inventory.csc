...
{
	weapon = namespace_ad5a0cd6::function_35e06774(inventoryitem.var_a6762160);
	if(!isdefined(weapon))
	{
		return 1;
	}
...
function private function_f3ef5269(localclientnum)
{
	...
	for(i = 0; i < 10; i++)
	{
		var_a638d314 = clientdata.inventory.items[i];
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						if(!isdefined(inventoryitem) || inventoryitem.var_bd027dd9 === 32767 || inventoryitem.var_a6762160.itemtype !== #"hash_56d6621e6c4caf07")
						{
	...
	while(true)
	{
		...
		if(waitresult._notify === var_5054e2f7)
		{
			...
			if(var_d8138db2 != 32767)
			{
				...
				if(ispc())
				{
					if(isdefined(clientdata.inventory.var_f3518190) && clientdata.inventory.var_f3518190.item.id == var_d8138db2)
					{
						clientdata.inventory.var_f3518190 = undefined;
						clientdata.inventory.var_4d4ec560 = undefined;
						setuimodelvalue(clientdata.inventory.consumed.var_a25538fb, function_3fe6ef04(localclientnum));
...
/*
	...
	Flags: Linked, Private
*/
function private function_1a99656a(localclientnum, inventoryitem, var_bd027dd9, var_d8138db2, count, totalcount, availableaction, var_e35261f6 = 1, var_189fcf49 = 0, var_1204dfe9 = 1)
{
	data = undefined;
	if(var_d8138db2 == 32767 && isdefined(inventoryitem.var_bd027dd9) && inventoryitem.var_bd027dd9 != 32767)
	{
		data = level.var_d342a3fd[localclientnum];
	}
	else
	{
		if(var_d8138db2 != 32767 && inventoryitem.var_bd027dd9 === 32767)
		{
			data = level.var_d342a3fd[localclientnum];
		}
		else if(isdefined(inventoryitem.var_a6762160) && inventoryitem.var_a6762160.itemtype === #"hash_56d6621e6c4caf07")
		{
			data = level.var_d342a3fd[localclientnum];
		}
	}
	var_dbce1e30 = 0;
	if(inventoryitem.id === var_d8138db2 && isdefined(inventoryitem.count) && inventoryitem.count > count)
	{
		var_dbce1e30 = 1;
		if(isdefined(inventoryitem.var_a6762160) && inventoryitem.var_a6762160.itemtype === #"hash_56d6621e6c4caf07")
		{
			clientdata = item_world::function_a7e98a1a(localclientnum);
	...
	player = function_27673a7(localclientnum);
	var_1bd87f37 = 1;
	if(isdefined(inventoryitem.var_a6762160) && inventoryitem.var_a6762160.itemtype == #"hash_56d6621e6c4caf07" && var_bd027dd9 == 32767 && var_1204dfe9 == 0)
	{
		var_1bd87f37 = 0;
	}
	...
	inventoryitem.var_a6762160 = (32767 == var_d8138db2 ? undefined : function_b1702735(var_d8138db2).var_a6762160);
	...
	if(isdefined(data))
	{
		...
		if(var_d8138db2 !== 32767 && isdefined(inventoryitem.var_a6762160) && inventoryitem.var_a6762160.itemtype === #"weapon")
		{
			foreach(var_4838b749 in array(16 + 1, ((16 + 1) + 6) + 1))
			{
		...
		if(var_d8138db2 !== 32767 && isdefined(inventoryitem.var_a6762160) && inventoryitem.var_a6762160.itemtype === #"attachment")
		{
			var_f9f8c0b5 = namespace_ad5a0cd6::function_808be9a3(player, inventoryitem.var_bd027dd9);
...
function private function_8bb02a48(localclientnum)
{
	...
	for(index = 0; index < var_7007b688.size && index < 2; index++)
	{
		...
		function_9a227103(createuimodel(var_7f695eed.itemuimodel, "totalCount"));
	}
...
function function_9c4460e0(localclientnum, var_d8138db2, count = 1, slotid = undefined)
{
	...
	player function_1a99656a(localclientnum, inventoryitem, var_bd027dd9, var_d8138db2, count, totalcount, availableaction);
}
...
function function_42e2bb1a(localclientnum)
{
	...
	{
		data.inventory.items[index].itemuimodel = createuimodel(var_dcb56aa8, "item" + index);
	...
	data.inventory.items[10].itemuimodel = createuimodel(var_dcb56aa8, "health");
	data.inventory.items[11].itemuimodel = createuimodel(var_dcb56aa8, "gear");
	data.inventory.items[13].itemuimodel = createuimodel(var_dcb56aa8, "storage");
	data.inventory.items[12].itemuimodel = createuimodel(var_dcb56aa8, "equipment");
	data.inventory.items[14].itemuimodel = createuimodel(var_dcb56aa8, "resource0");
	data.inventory.items[15].itemuimodel = createuimodel(var_dcb56aa8, "resource1");
	data.inventory.items[16].itemuimodel = createuimodel(var_dcb56aa8, "shard0");
	var_d42bc614 = array(16 + 1, ((16 + 1) + 6) + 1);
	for(index = 0; index < var_d42bc614.size; index++)
	{
		var_4838b749 = var_d42bc614[index];
		data.inventory.items[var_4838b749].itemuimodel = createuimodel(var_dcb56aa8, "weapon" + index);
		var_55022c4f = array(1, 2, 3, 4, 5, 6);
		for(attachmentindex = 0; attachmentindex < var_55022c4f.size; attachmentindex++)
		{
			var_259f58f3 = var_55022c4f[attachmentindex];
			...
			data.inventory.items[var_f9f8c0b5].itemuimodel = createuimodel(var_dcb56aa8, "attachment" + var_cdc380b6);
		}
	}
	for(index = 0; index < data.inventory.items.size; index++)
	{
...
function function_8063170(inventoryitem, equipped)
{
	...
	if(inventoryitem.var_a6762160.itemtype === #"hash_56d6621e6c4caf07")
	{
		return;
	}
...
function function_26c87da8(localclientnum, var_c9293a27, var_8f194e5a)
{
	...
	player = function_27673a7(localclientnum);
	player function_1a99656a(localclientnum, toitem, (var_23501832 != 32767 ? namespace_ad5a0cd6::function_970b8d86(player, var_8f194e5a) : 32767), var_a2dd129a, var_3907299e, function_bba770de(localclientnum, var_b208c7e1), var_57b0c2f, undefined, 1);
	player function_1a99656a(localclientnum, fromitem, (var_9269cd0a != 32767 ? namespace_ad5a0cd6::function_970b8d86(player, var_c9293a27) : 32767), var_d3a45360, var_532f304, function_bba770de(localclientnum, var_ec763bb2), var_ad138826, undefined, 1);
...
function function_9116bb0e(localclientnum, closed = 0)
{
	...
	if(isdefined(clientdata.var_f0f7e918) && !closed)
	{
		...
		foreach(i, itemdef in clientdata.var_f0f7e918)
		{
			...
			setuimodelvalue(createuimodel(itemmodel, "claimsInventorySlot"), function_7146ceb2(localclientnum, itemdef.var_a6762160) && !function_a4a6f064(localclientnum, itemdef.var_a6762160));
			setuimodelvalue(createuimodel(itemmodel, "stackCount"), 0);
			setuimodelvalue(createuimodel(itemmodel, "stashStackSize"), 0);
