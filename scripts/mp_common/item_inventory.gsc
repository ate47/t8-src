...
function private function_38d1ea04()
{
	if(isplayer(self) && isdefined(self.inventory))
	{
		...
		{
			var_39c78394 = inventoryitem.var_a6762160.var_39c78394;
		}
		if(isdefined(var_39c78394) && var_39c78394 > 0)
		{
			armorShard = function_4ba8fde(#"hash_2e33ce38d6cda617");
			if(isdefined(armorShard))
			{
				var_7841fe31 = self function_e274f1fe(armorShard, var_39c78394, undefined, 16);
				if(var_7841fe31 > 0)
				{
...
/*
	...
	Flags: Linked, Private
*/
function private function_d7944517(var_d8138db2, weapon, count, amount, stashitem = 0, var_7cab8e12 = undefined, targetname = undefined, attachments = undefined)
{
	/#
		assert(isplayer(self));
	#/
	...
	return self item_drop::drop_item(weapon, count, amount, var_d8138db2, droppos, (0, randomintrange(0, 360), 0), stashitem, 0, targetname, undefined, attachments);
}
...
function private function_ee9ce1c4(var_a6762160, var_dfe6c7e5 = 0)
{
	self endon(#"death");
	self.var_10abd91d = 1;
	self replace_weapon(namespace_ad5a0cd6::function_35e06774(var_a6762160), level.nullprimaryoffhand);
...
function function_20ecd64d()
{
	...
	{
		item = _cycle_item(#"equipment", array(#"hash_53a2516ec1d3a096", #"hash_3074c41bb205ed8c", #"hash_2b5027622c0b6d07", #"hash_4cec712579f1202f", #"hash_57504010ce1814dc", #"hash_5752a7e130ea202a", #"hash_4edf613e9b9032da", #"hash_28da32d9304b6296", #"hash_4a2739676c12d92a", #"hash_140318e970e711ce", #"hash_50b970644e43947b", #"hash_627144159973c325", #"hash_1a7edb90a484158b", #"hash_745d80b3e4f28da1", #"hash_56e573d15c6402bc", #"hash_213093d947c30be6", #"hash_7e8c84081fafaea4", #"hash_665eccfe5d58f636", #"hash_68b64725de40edae", #"hash_2b06a3f530395182", #"hash_16a1f841da0b877d", #"hash_1242946e889704c7", #"hash_14b578e446580ad5", #"hash_300914db9caf4033", #"hash_3a3d830a9a4559d4", #"hash_743b859c2367ff54", #"hash_5e5f2ed57ac4601f", #"hash_105f32560e2fb0fe", #"hash_18056dab055a44c9", #"hash_2e8b13391f6544", #"hash_735d22a674b7f8c0", #"wz_snowball", #"wz_waterballoon"), var_bcc2655a);
	}
	else
	{
...
function function_9ba10b94(var_bd027dd9)
{
	...
	foreach(var_259f58f3 in array(1, 2, 3, 4, 5, 6))
	{
		...
		{
			attachmentweapons[attachmentweapons.size] = namespace_ad5a0cd6::function_f4a8d375(item.id);
...
function function_9d102bbd(var_b72297c2, var_bd027dd9)
{
	...
	weaponitem = function_dfcacdc2(var_bd027dd9);
	...
	if(isdefined(var_b72297c2.attachments) || isdefined(var_b72297c2.var_a6762160.attachments))
	{
		...
		foreach(attachment in attachments)
		{
			...
			dropweapons[dropweapons.size] = namespace_ad5a0cd6::function_f4a8d375(attachmentitem.id);
			var_cf804066[var_cf804066.size] = attachmentitem.id;
		}
	}
...
function function_fba40e6c(item)
{
	...
	if(!isdefined(item))
	{
		...
		{
			self function_5a0ba107(inventoryitem.var_bd027dd9);
		}
	...
	if(item.var_a6762160.itemtype == #"attachment")
	{
		...
		if(isdefined(var_4838b749))
		{
			...
			if(self.inventory.items[var_4838b749].var_bd027dd9 != 32767)
			{
				...
				weaponitem = self function_dfcacdc2(var_f0dc4e93);
...
function drop_armor(stashitem = 0, var_7cab8e12 = undefined, targetname = undefined)
{
	...
	if(self has_armor())
	{
		...
		self thread function_418f9eb8(item.var_bd027dd9, stashitem, var_7cab8e12, targetname);
		return true;
	}
	return false;
}
...
function function_d86d7ac7(stashitem = 0, var_7cab8e12 = undefined, targetname = undefined)
{
	...
	for(index = self.inventory.var_c212de25; index < 10; index++)
	{
		...
		{
			self thread function_418f9eb8(inventoryitem.var_bd027dd9, stashitem, var_7cab8e12, targetname);
		}
	}
}
...
/*
	...
	Flags: Linked
*/
function function_418f9eb8(var_bd027dd9, stashitem = 0, var_7cab8e12 = undefined, targetname = undefined, var_4a6f595d = 1)
{
	/#
		assert(isplayer(self));
	#/
...
{
	var_a6762160 = item.var_a6762160;
	inventoryitem = function_dfcacdc2(item.var_bd027dd9);
	if(!isdefined(inventoryitem))
	{
		return;
	}
	...
	if(isdefined(weapon) && weapon != level.weaponnone)
	{
		...
		if(initialweaponraise && !isdefined(item.weaponoptions) && !isdefined(item.var_3a7d925b) && !isdefined(item.var_2febbde5))
		{
			...
			else
			{
				...
				var_3a7d925b = self function_9826b353(buildkitweapon);
		...
		self replace_weapon(currentweapon, weapon, 1, initialweaponraise, var_a3a17c55, item.weaponoptions, item.var_3a7d925b, item.var_2febbde5);
		if(var_6073ab7b)
		{
			...
			if(itemcount <= 0)
			{
				if(isdefined(item.attachments))
				{
					foreach(attachmentitem in item.attachments)
					{
						...
						function_e274f1fe(attachmentitem, undefined, undefined, var_f9f8c0b5);
						attachmentitem = function_dfcacdc2(attachmentitem.var_bd027dd9);
...
/*
	...
	Flags: Linked
*/
function replace_weapon(old_weapon, new_weapon, primary_weapon = 0, var_e47b0bf = 1, var_6086c488 = 0, options = undefined, var_3a7d925b = undefined, var_2febbde5)
{
	/#
...
function function_a2c7ce35()
{
	...
	for(var_25c45152 = 0; var_25c45152 < var_3e9ef0a1.size; var_25c45152++)
	{
		...
		{
			var_7f695eed = equipmentitems[index];
			var_f77e15f6 = function_4ba8fde(var_7f695eed);
			if(!isdefined(var_f77e15f6))
			{
				continue;
			}
			maxstack = namespace_a0d533d1::function_cfa794ca(self.inventory.var_7658cbec, var_f77e15f6.var_a6762160);
...
function function_2bb3a825()
{
	...
	for(index = var_9b624be0.size - 1; index >= 0; index--)
	{
		...
		var_f77e15f6 = function_4ba8fde(healthitem);
		if(!isdefined(var_f77e15f6))
		{
			continue;
		}
...
function function_56a681fb()
{
	...
	foreach(ammoweapon, var_d8138db2 in self.inventory.ammo)
	{
...
function function_b3342af3(item, notifyclient = 1, var_2ea908ac = undefined)
{
	...
	foreach(slotid in array(16 + 1, ((16 + 1) + 6) + 1))
	{
		...
		weaponitem = function_dfcacdc2(var_f0dc4e93);
...
/*
	...
	Flags: Linked
*/
function function_41a57271(item, slot, notifyclient = 1, var_b2bd0862 = undefined)
{
	/#
		assert(isplayer(self));
	#/
	...
	foreach(attachment in attachments)
	{
		...
		{
			function_b3342af3(function_dfcacdc2(attachment.var_bd027dd9), notifyclient);
		}
	}
}
