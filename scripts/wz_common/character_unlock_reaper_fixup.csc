...
function __init__()
{
	character_unlock_fixup::register_character_unlock(#"reaper_unlock", #"hash_76cce42bfc9866cd", #"hash_68307ed314684f1d", &function_d95e620c, #"hash_555c37b28c4a770c", #"hash_555c3ab28c4a7c25");
}
