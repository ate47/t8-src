...
function function_3335f286()
{
	...
	zm_sq::register(#"main_quest", #"door_interact", #"door_interact", &function_1cb738a0, &function_ebe10128);
...
function function_e028a26f(var_2c03c1e4, var_9410d484 = 1, b_return = 0)
{
	...
	str_cf = var_a5e426e5[var_2c03c1e4];
	if(!isbot(self))
	{
		if(var_9410d484)
		{
...
function function_b22c312e(var_2c03c1e4)
{
	...
	w_uncharged = function_a67dc10(var_2c03c1e4);
...
{
	a_e_players = function_e3142c13();
	return isdefined(a_e_players[#"hash_1e10943309f858e"]) || isdefined(a_e_players[#"bruno"]);
}
