...
{
	zm_sq::register(#"main_quest", #"oil", #"oil", &function_e4dadb03, &function_bda20d06);
	zm_sq::register(#"main_quest", #"reflect", #"reflect", &function_8da2802b, &function_46087bd2);
	zm_sq::register(#"main_quest", #"split", #"split", &function_fa377cf7, &function_1a787421);
	zm_sq::register(#"prophecy", #"shoot_roots", #"shoot_roots", &function_6c7d67a0, &function_593e3d1f);
	zm_sq::register(#"prophecy", #"hash_2e55ff1b489306ce", #"hash_2e55ff1b489306ce", &function_c311ba46, &function_d0656fba);
	zm_sq::register(#"prophecy", #"hash_7f8f1fe8f7b285d0", #"hash_7f8f1fe8f7b285d0", &function_f7b5ebc7, &function_3fda7cb);
	zm_sq::register(#"prophecy", #"hash_51920e5d18511f72", #"hash_51920e5d18511f72", &function_ceb38216, &function_8d2b7b74);
	zm_sq::register(#"prophecy", #"hash_38a06e6fa57d2c74", #"hash_38a06e6fa57d2c74", &function_d424710c, &function_7724c926);
	zm_sq::register(#"light", #"hash_59b9d987109997c8", #"hash_59b9d987109997c8", &function_f342bc18, &function_beb7d290);
	zm_sq::register(#"light", #"hash_540790592c78a3cb", #"hash_540790592c78a3cb", &function_5cd1e2d4, &function_9e4314ec);
	zm_sq::register(#"light", #"give_ankh", #"give_ankh", &function_7c9ece4f, &function_3b1a65ee);
	zm_sq::register(#"light", #"hash_177b41a8c9da003b", #"hash_177b41a8c9da003b", &function_4259a2c9, &function_ddcd9609);
	zm_sq::register(#"light", #"hash_2ef35a0caeaf1677", #"hash_2ef35a0caeaf1677", &function_ec93aa41, &function_63c49b59);
	zm_sq::register(#"light", #"hash_6f1d1e83bc66b715", #"hash_6f1d1e83bc66b715", &function_1533614, &function_8faf150e);
	...
	zm_sq::register(#"main_quest", #"blood", #"blood", &function_2954c1bf, &function_e74f32a2);
	zm_sq::register(#"main_quest", #"hash_75294573d425dff4", #"hash_75294573d425dff4", &function_1cb738a0, &function_ebe10128);
	zm_sq::register(#"main_quest", #"mid_igc", #"mid_igc", &function_ce32cc66, &function_e5cd3130);
	zm_sq::register(#"main_quest", #"cleanse", #"cleanse", &function_d2ab893e, &function_8dc89390);
	zm_sq::register(#"main_quest", #"hash_1f875aef67e9ade4", #"hash_1f875aef67e9ade4", &function_5e84e8f9, &function_8000f525);
	zm_sq::register(#"main_quest", #"hash_d861e03ebf38f96", #"hash_d861e03ebf38f96", &function_2f9d2650, &function_358b40ed);
	zm_sq::register(#"main_quest", #"teleport", #"teleport", &function_22165535, &function_9f8fe5ae);
...
/*
	...
	Flags: Linked
*/
function function_bda20d06(b_skipped, var_19e802fa)
{
...
function function_e3ed59fb()
{
	...
	foreach(s_monument in var_3d8894cc)
	{
...
function spartan_monuments()
{
	...
	while(level.var_6775c28d.size > 0)
	{
		...
		foreach(var_407cfce6 in level.var_6775c28d)
		{
			if(isdefined(var_407cfce6) && (!(isdefined(var_407cfce6.b_shot) && var_407cfce6.b_shot)))
			{
				...
				s_result = undefined;
				s_result = var_407cfce6 waittilltimeout(var_4c07cedf, #"hash_2a4e028a916b763d");
	...
	while(!var_b6225a1f)
	{
		var_4c07cedf = function_2a9c51b5();
		s_result = undefined;
		s_result = level.var_67c7040c waittilltimeout(var_4c07cedf, #"clean_up", #"hash_2a4e028a916b763d");
...
/*
	...
	Flags: Linked
*/
function function_46087bd2(b_skipped, var_19e802fa)
{
...
function function_8b20a029()
{
	...
	var_eb37cc87 = util::spawn_model(#"wpn_t8_zm_red_spear_world", var_e18247ac, var_399ded8a);
	...
	if(level.var_eb5ed779.size >= 3)
	{
		...
		util::spawn_model(#"wpn_t8_zm_red_spear_world", level.var_20622c6.origin, var_399ded8a);
		foreach(var_8899ca5c in level.var_eb5ed779)
		{
...
/*
	...
	Flags: Linked
*/
function function_1a787421(b_skipped, var_19e802fa)
{
	level notify(#"hash_1beb529f935869e4");
	callback::remove_on_connect(&function_b8911151);
...
function function_3ffc2c9e()
{
	...
	s_prophecy.var_ee799ebb = var_ee799ebb;
...
function function_6c7d67a0(b_skipped)
{
	...
	var_ee799ebb = s_prophecy.var_ee799ebb;
	...
	s_prophecy.var_79a46648 = var_b01f45f0;
	...
	while(true)
	{
		...
		foreach(str_difficulty, a_roots in var_ee799ebb)
		{
...
/*
	...
	Flags: Linked
*/
function function_593e3d1f(b_skipped, var_19e802fa)
{
	s_prophecy = level.var_cc9c60d2;
	var_f18de103 = s_prophecy.var_79a46648;
	...
	var_d9d7f557 = s_prophecy.var_ee799ebb;
	foreach(var_ee799ebb in var_d9d7f557)
	{
		foreach(s_root in var_ee799ebb)
		{
			s_root scene::stop(1);
...
function function_310741f7(var_1cd2521, n_time_limit)
{
	level endon(#"end_game", #"shoot_roots" + "_ended_early");
	s_prophecy = level.var_cc9c60d2;
	var_ee799ebb = s_prophecy.var_ee799ebb[var_1cd2521];
	s_prophecy.var_c77a0713 = 0;
	s_prophecy.var_46b09973 = var_ee799ebb.size;
	var_b01f45f0 = s_prophecy.var_79a46648;
...
function function_c311ba46(b_skipped)
{
	...
	while(true)
	{
		ai_gegenees = namespace_75cbf125::spawn_single(1, s_scene);
...
/*
	...
	Flags: Linked
*/
function function_d0656fba(b_skipped, var_19e802fa)
{
...
/*
	...
	Flags: Linked
*/
function function_3fda7cb(b_skipped, var_19e802fa)
{
	s_backup = struct::get(#"hash_7c6d4a7c40906a70");
...
/*
	...
	Flags: Linked
*/
function function_8d2b7b74(b_skipped, var_19e802fa)
{
	s_loc = struct::get(#"hash_1deabdaf47d6a78");
...
/*
	...
	Flags: Linked
*/
function function_7724c926(b_skipped, var_19e802fa)
{
...
function function_ca906c66(e_player)
{
	...
	if(e_player zm_characters::is_character(array(#"hash_7180c6cf382f6010", #"hash_14e91ceb9a7b3eb6")))
	{
		...
		if(b_played === 1)
		{
			e_player thread zm_vo::function_8e0f4696(#"hash_5b1fc7fce1734175", undefined, undefined, undefined, undefined, 1);
		}
	}
...
{
	if(self.archetype == #"catalyst" && self.var_9fde8624 == #"hash_266b62e342076a90")
	{
		s_prophecy = level.var_cc9c60d2;
		var_eb37cc87 = s_prophecy.var_eb37cc87;
...
function function_3c71e07d()
{
	...
	for(i = 0; i < 2; i++)
	{
		...
		while(true)
		{
			...
			var_e244831f = getaiarchetypearray(#"catalyst");
			var_e7f5b3e0 = 1;
			foreach(ai_catalyst in var_e244831f)
			{
				if(isalive(ai_catalyst) && ai_catalyst.var_9fde8624 == #"hash_266b62e342076a90")
				{
					var_e7f5b3e0 = 0;
					break;
				}
			}
			if(var_e7f5b3e0 && !zm_transform::function_abf1dcb4(#"hash_266b62e342076a90"))
			{
...
function function_8e8da19a()
{
	...
	self endon(#"death");
	s_prophecy = level.var_cc9c60d2;
	var_80841b2c = getstatuseffect("blind_zm_catalyst");
	while(true)
	{
		var_be17187b = undefined;
...
/*
	...
	Flags: Linked
*/
function function_beb7d290(b_skipped, var_19e802fa)
{
...
function function_49b3f5aa()
{
	...
	while(true)
	{
		...
		if(var_eb3b90d.size > 0)
		{
			...
			while(true)
			{
				ai_gegenees = namespace_75cbf125::spawn_single(1, s_spawn);
				if(isdefined(ai_gegenees))
				{
					return;
				}
...
/*
	...
	Flags: Linked
*/
function function_9e4314ec(b_skipped, var_19e802fa)
{
	s_loc = struct::get(#"hash_6812ea5a7f9fdf21");
	if(isdefined(s_loc))
	{
...
/*
	...
	Flags: Linked
*/
function function_3b1a65ee(b_skipped, var_19e802fa)
{
	s_loc = struct::get(#"hash_68e5680a6c84cf71");
	if(isdefined(s_loc))
	{
...
/*
	...
	Flags: Linked
*/
function function_ddcd9609(b_skipped, var_19e802fa)
{
	function_9f390ef0(0);
...
function function_6511349e()
{
	...
	var_be17187b = undefined;
	var_be17187b = level waittilltimeout(s_light.var_93919a1f, #"hash_d0d79bd22a685c1");
...
function function_e5352d71()
{
	...
	foreach(var_740e1e0e in var_8d5cca6b)
	{
		...
		while(true)
		{
			n_start_time = gettime();
			var_be17187b = undefined;
			var_be17187b = level waittilltimeout(n_time_left, #"hash_d0d79bd22a685c1");
			if(var_be17187b._notify == #"hash_d0d79bd22a685c1")
			{
				var_f661e07a = gettime();
...
function function_e4162ab8()
{
	...
	level notify(#"hash_d0d79bd22a685c1", {#n_cf:n_cf, #hash_83aeafd6:self});
...
/*
	...
	Flags: Linked
*/
function function_63c49b59(b_skipped, var_19e802fa)
{
...
/*
	...
	Flags: Linked
*/
function function_8faf150e(b_skipped, var_19e802fa)
{
	s_loc = struct::get(#"hash_56ba037bba790648");
	if(isdefined(s_loc))
	{
...
function function_5436fd42()
{
	...
	var_be17187b = undefined;
	var_be17187b = level waittilltimeout(60, #"light_second_part");
...
function function_488a4eb2(b_skipped, var_19e802fa)
{
	...
	/#
		if(b_skipped || var_19e802fa)
		{
			var_3a390e15 = array(#"prophecy", #"light");
			foreach(str_step in var_3a390e15)
			{
...
/*
	Name: registerelectricity_rune_quest_startteleportinterminate
	Namespace: zm_red_main_quest
	Checksum: 0x2F40EFBF
	Offset: 0x115B8
	Size: 0x454
...
function registerelectricity_rune_quest_startteleportinterminate()
{
	...
	s_play.var_59f7dee9 = var_59f7dee9;
...
function play_cleanup(b_skipped, var_19e802fa)
{
	...
	var_59f7dee9 = s_play.var_59f7dee9;
	array::delete_all(var_59f7dee9);
	...
	while(true)
	{
		while(true)
		{
			...
			foreach(e_player in util::get_active_players())
			{
				...
				{
					if(e_player function_3d581a6(#"earth", 0))
					{
						var_2c03c1e4 = #"earth";
					}
					else
					{
						if(e_player function_3d581a6(#"air", 0))
						{
							var_2c03c1e4 = #"air";
						}
		...
		s_play.var_fc14780a = var_fc14780a;
		s_play.var_38993303 = var_fc14780a.size;
		...
		var_be17187b = undefined;
		var_be17187b = level waittilltimeout(3, #"hash_285de4ce79135552");
	...
	foreach(e_player in a_e_players)
	{
		if(zm_utility::is_player_valid(e_player) && e_player zm_audio::function_65e5c19a())
		{
			if(e_player zm_characters::is_character(array(#"hash_7180c6cf382f6010", #"hash_14e91ceb9a7b3eb6")))
			{
				...
				if(isdefined(b_played) && b_played)
				{
					e_player thread zm_vo::function_8e0f4696(#"hash_242d4dda05399a77", undefined, undefined, undefined, undefined, 1);
				}
			}
			else
			{
...
/*
	Name: clear_lockon_after_grappleattackstart
	Namespace: zm_red_main_quest
	Checksum: 0xF0E7E274
	Offset: 0x13448
	Size: 0x138
...
function function_93e711a6(s_params)
{
	...
	{
		s_play = level.var_28dcf408;
		s_play.var_155837a1[var_2c03c1e4]++;
	}
	else
	{
...
/*
	...
	Flags: Linked
*/
function function_813c4629(s_spotlight, var_2c03c1e4)
{
...
/*
	...
	Flags: Linked
*/
function function_5d2011fa(s_spotlight, var_2c03c1e4, n_duration)
{
	...
	n_start_time = gettime();
	while(self function_813c4629(s_spotlight, var_2c03c1e4))
	{
	...
	for(var_12caf287 = 1; var_12caf287 <= 3; var_12caf287++)
	{
		...
		for(i = 0; i < n_parts; i++)
		{
			...
			foreach(var_2c03c1e4, e_player in var_fc14780a)
			{
				...
				{
					s_previous = var_55b0fa0c[var_2c03c1e4];
					var_f7dfd45a = arraycopy(var_39324db2);
					arrayremovevalue(var_f7dfd45a, s_previous);
					s_spotlight = arraygetfarthest(e_player.origin, var_f7dfd45a);
			...
			foreach(var_2c03c1e4, e_player in var_fc14780a)
			{
				if(isinarray(var_bddee53a, var_2c03c1e4))
				{
					...
					s_spotlight = var_55b0fa0c[var_2c03c1e4];
					...
					n_task = array::find(var_bddee53a, var_2c03c1e4);
...
function function_9cb5a6ac(var_2c03c1e4, str_task, var_12caf287, n_spotlight, var_d8d4faff)
{
	...
	if(b_return)
	{
		var_24437625 = 1;
		var_c9386af2 = 5;
		s_spotlight = var_59f7dee9[var_2c03c1e4];
		var_fb51c008 = self function_6a5bdb08();
	}
	else
	{
		var_24437625 = n_spotlight + 1;
		s_spotlight = var_59f7dee9[n_spotlight];
	...
	if(!var_fb51c008)
	{
		...
		var_be17187b = undefined;
		var_be17187b = self waittilltimeout(var_c9386af2, #"hash_29f30403ceebc819");
		level clientfield::set(var_8c827c67, 0);
		self notify(#"hash_3f61d1172dd383b2");
	...
	if(!b_return)
	{
		level thread function_542a6ee4(self, var_2c03c1e4, str_task, n_spotlight, var_d8d4faff);
		level thread function_4462d56a(self, var_2c03c1e4);
		var_be17187b = undefined;
		var_be17187b = self waittilltimeout(var_bfa3340e, #"hash_794badff330d135f");
	...
	s_play.var_ef5091fc++;
	var_2d971fd7 = s_play.var_fc14780a.size;
...
/*
	...
	Flags: Linked
*/
function function_542a6ee4(e_player, var_2c03c1e4, str_task, n_spotlight, var_d8d4faff)
{
	level endon(#"end_game", #"play" + "_ended_early", #"hash_285de4ce79135552");
	...
	s_play = level.var_28dcf408;
	n_to_kill = 0;
	s_play.var_155837a1[var_2c03c1e4] = 0;
	...
	while(s_play.var_155837a1[var_2c03c1e4] < n_to_kill)
	{
		waitframe(1);
	}
...
/*
	...
	Flags: Linked
*/
function function_37411f7e(var_eb3b90d, var_2c03c1e4, b_uncharged, b_stationary, var_d8d4faff)
{
	level endon(#"end_game", #"play" + "_ended_early", #"hash_285de4ce79135552");
	foreach(s_spawn in var_eb3b90d)
	{
		s_spawn function_6cdf4b0(var_2c03c1e4, b_uncharged, b_stationary, var_d8d4faff);
		util::wait_network_frame();
	}
}
...
/*
	...
	Flags: Linked
*/
function function_6cdf4b0(var_2c03c1e4, b_uncharged, b_stationary, var_d8d4faff)
{
	level endon(#"end_game", #"play" + "_ended_early", #"hash_285de4ce79135552");
	self endon(#"death");
	b_spartoi = 0;
...
function function_26af8a57()
{
	...
	foreach(n_rune in var_736d4873)
	{
	...
	s_blood.var_8b3ef4f7 = var_8b3ef4f7;
...
/*
	...
	Flags: Linked
*/
function function_e74f32a2(b_skipped, var_19e802fa)
{
	callback::function_deba137d(&function_b224d9eb);
	level notify(#"hash_59e7b50156995646");
	s_blood = level.var_d16c3b5;
	var_8b3ef4f7 = s_blood.var_8b3ef4f7;
	mdl_door = getent("mdl_blood_code", "targetname");
...
/*
	...
	Flags: Linked
*/
function function_ebe10128(b_skipped, var_19e802fa)
{
...
function function_c3735f60(e_player)
{
	if(zm_utility::is_player_valid(e_player) && e_player function_90836224() && (isdefined(e_player.var_4f958d45) && e_player.var_4f958d45) && (!(isdefined(e_player.var_564dec14) && e_player.var_564dec14)))
	{
		...
		e_bruno = a_e_players[#"hash_6becd1d9b42235f"];
		if(var_5e0ce220 === e_player)
		{
			var_57ce903d = e_bruno;
...
function function_e3142c13()
{
	...
	{
		a_e_players[#"hash_6becd1d9b42235f"] = e_bruno;
	}
	return a_e_players;
}
...
function function_ce32cc66(b_skipped)
{
	...
	var_5e0ce220 = function_153ee6c7(array(#"hash_3e63362aea484e09", #"hash_5a906d7137467771"));
	e_bruno = function_153ee6c7(array(#"hash_7180c6cf382f6010", #"hash_14e91ceb9a7b3eb6"));
	if(!isdefined(var_5e0ce220) && !isdefined(e_bruno))
	{
		return;
	}
	...
	if(!isdefined(var_5e0ce220))
	{
		...
		s_blood.var_c702bbb0 = var_5e0ce220;
		var_5e0ce220 zm_characters::set_character(array(#"hash_3e63362aea484e09", #"hash_5a906d7137467771"));
	...
	foreach(e_actor in array(var_5e0ce220, e_bruno))
	{
		...
		foreach(var_b9a803af in var_2d23a7ee)
		{
			...
			if(var_beb2295 === e_actor)
			{
				...
				level thread zm_ai_blight_father::function_c526065b(var_b9a803af);
				break;
			}
		}
	...
	{
		var_b5d11642 = 1;
		foreach(e_player in array(var_5e0ce220, e_bruno))
		{
			if(!isdefined(e_player))
			{
				return;
	...
	zm_red_challenges::function_33565c6e(1);
	...
	e_bruno setorigin(var_eaf1740a.origin);
	...
	level scene::play(#"hash_53792003d706a2e", array(var_5e0ce220, e_bruno, mdl_door));
	zm_red_challenges::function_33565c6e(0);
...
function function_f81bfa93(a_ents)
{
	...
	var_5e0ce220 = a_ents[#"e_blood_scar"];
	...
	level thread function_cce14a84(var_5e0ce220, e_bruno);
...
/*
	...
	Flags: Linked
*/
function function_cce14a84(var_5e0ce220, e_bruno)
{
	wait(0.1);
	s_blood = level.var_d16c3b5;
...
function function_b8834fae(var_bcf66490)
{
	...
	foreach(e_player in getplayers())
	{
		...
		{
			if(e_player !== var_5e0ce220 && e_player !== e_bruno)
			{
				e_player.dontspeak = 1;
				e_player scene::function_8b06792(#"hash_53792003d706a2e");
			}
			if(isdefined(var_5e0ce220) && e_player === var_5e0ce220 || (isdefined(e_bruno) && e_player === e_bruno))
			{
...
/*
	...
	Flags: Linked
*/
function function_e5cd3130(b_skipped, var_19e802fa)
{
	s_blood = level.var_d16c3b5;
	...
	else
	{
		...
		if(isdefined(var_5e0ce220))
		{
			...
			{
				var_5e0ce220 giveweapon(w_shield);
			}
			if(isdefined(s_blood.var_9f2db310) && s_blood.var_9f2db310)
			{
	...
	else
	{
		...
		if(isdefined(e_bruno))
		{
			e_bruno val::reset(#"hash_3d6959de8fb9ed1a", "disable_weapons");
			e_bruno.var_f22c83f5 = undefined;
			e_bruno.var_f4e33249 = undefined;
			e_bruno.var_6b830459 = undefined;
			e_bruno val::reset(#"hash_55fd1fb4f9d0d36a", "takedamage");
			e_bruno val::reset(#"hash_4bf78d3b9951a760", "ignoreme");
			e_bruno val::reset(#"hash_bdeb2459b0170b1", "ignoreall");
...
function function_cb724dc5()
{
	...
	if(isdefined(var_5e0ce220) && isdefined(e_bruno))
	{
		...
		b_played = var_5e0ce220 zm_vo::function_8e0f4696(#"hash_66cea79656de98a3", undefined, undefined, undefined, undefined, 1);
		if(isdefined(b_played) && b_played)
		{
			b_played = 0;
			b_played = var_5e0ce220 zm_vo::function_a2bd5a0c(#"hash_62227711901aad2");
			if(isdefined(b_played) && b_played)
			{
	...
	else
	{
		...
		{
			var_5e0ce220 endon(#"disconnect");
			b_played = var_5e0ce220 zm_vo::function_8e0f4696(#"hash_72f5967a35325ac3", undefined, undefined, undefined, undefined, 1);
			if(isdefined(b_played) && b_played)
			{
				var_5e0ce220 thread zm_vo::function_a2bd5a0c(#"hash_3e5825fcf6f95472");
			}
		}
		else if(isdefined(e_bruno))
		{
			...
			if(isdefined(b_played) && b_played)
			{
				e_bruno thread zm_vo::function_8e0f4696(#"hash_1b221d6248a53127", undefined, undefined, undefined, undefined, 1);
			}
		}
	}
}
...
function function_dcc3c705()
{
	...
	while(level.var_3dd1c71a < 3)
	{
		...
		switch(level.var_3dd1c71a)
		{
			case 0:
			{
				self thread zm_vo::function_8e0f4696(#"hash_189f560c95cb6d61", undefined, undefined, undefined, undefined, 1);
				break;
			}
			case 2:
			{
				self thread zm_vo::function_8e0f4696(#"hash_dcc0683b777af3", undefined, undefined, undefined, undefined, 1);
				break;
			}
		}
		level.var_3dd1c71a++;
...
function function_db9be550(a_ents)
{
	...
	{
		s_cleanse.var_19a09d0c = a_ents[#"hash_7aff0ee60ddd937b"];
...
/*
	...
	Flags: Linked
*/
function function_8dc89390(b_skipped, var_19e802fa)
{
	s_cleanse = level.var_29e8cce2;
...
function function_67e537fd(a_ents)
{
	...
	if(isdefined(s_cleanse))
	{
		s_cleanse.var_10d4f67d = a_ents[#"hash_7aff0ee60ddd937b"];
...
/*
	...
	Flags: Linked
*/
function function_8000f525(b_skipped, var_19e802fa)
{
...
/*
	...
	Flags: Linked
*/
function function_358b40ed(b_skipped, var_19e802fa)
{
...
/*
	...
	Flags: Linked
*/
function function_9f8fe5ae(b_skipped, var_19e802fa)
{
...
function function_7b345f6d(str_alias)
{
	...
	foreach(i, e_player in var_3562ed6)
	{
		...
		if(!var_dc5f4a1c)
		{
			e_player thread zm_vo::function_8e0f4696(str_alias, undefined, undefined, undefined, 1);
			continue;
		}
		b_played = e_player zm_vo::function_8e0f4696(str_alias, undefined, undefined, undefined, 1);
	}
	return b_played;
}
