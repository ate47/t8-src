...
function function_841236e4(w_weapon, var_b6bc44ed)
{
	...
	if(w_weapon.name === #"ww_hand_h_uncharged" || w_weapon.name === #"ww_hand_h" || w_weapon.name === #"hash_403bfa4250f7a743")
	{
	...
	{
		if(w_weapon.name === #"hash_438bbe9c4a6cb14d" || w_weapon.name === #"ww_hand_c" || w_weapon.name === #"hash_6fed6a04129cb670")
		{
		...
		{
			if(w_weapon.name === #"hash_31785bdec07e2919" || w_weapon.name === #"ww_hand_o" || w_weapon.name === #"hash_508ba13614577e04")
			{
				var_caa76b60 = #"air";
			}
			else if(w_weapon.name === #"hash_57feb2fb3f73d361" || w_weapon.name === #"ww_hand_g" || w_weapon.name === #"hash_7d9d24e1aef966fc")
			{
				var_caa76b60 = #"earth";
			}
		}
...
function on_player_damage(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime)
{
	if(idamage >= self.health || level flag::get("round_reset"))
	{
		...
		else
		{
			...
			{
				if(self flag::get(#"hash_3247dad158e8b329"))
				{
					self notify(#"hash_2026d806e71dfad5", {#b_success:0});
				}
				else
				{
					if(self function_996fee51() === getweapon(#"hash_438bbe9c4a6cb14d"))
					{
						self function_41234931(1);
					}
					else
					{
						if(self getcurrentweapon() === level.var_3eccc872)
						{
...
{
	if(w_weapon === getweapon(#"ww_hand_h_uncharged") || w_weapon === getweapon(#"hash_438bbe9c4a6cb14d") || w_weapon === getweapon(#"hash_57feb2fb3f73d361") || w_weapon === getweapon(#"hash_31785bdec07e2919") || w_weapon === getweapon(#"ww_hand_h") || w_weapon === getweapon(#"ww_hand_c") || w_weapon === getweapon(#"ww_hand_g") || w_weapon === getweapon(#"ww_hand_o") || w_weapon === getweapon(#"hash_403bfa4250f7a743") || w_weapon === getweapon(#"hash_6fed6a04129cb670") || w_weapon === getweapon(#"hash_7d9d24e1aef966fc") || w_weapon === getweapon(#"hash_508ba13614577e04"))
	{
		return true;
	}
	return false;
...
function function_9aa785fe(e_player)
{
	...
	while(true)
	{
		...
		if(var_be17187b.e_who === e_player && w_hand === self.var_884c4b3a && !e_player flag::get(#"hash_8cdde8e6a8607f1") && w_hand != level.var_3eccc872)
		{
...
function function_7f7c692(var_fc6baa64)
{
	...
	var_be17187b = undefined;
	var_be17187b = self waittilltimeout(30, #"fake_death");
...
function function_f25f67a7()
{
	...
	else
	{
		if(isdefined(w_hand))
		{
			...
			{
				if(w_hand === getweapon(#"hash_438bbe9c4a6cb14d"))
				{
					var_f5716a6 = 1;
					var_64d8621e = 2;
				}
				...
				{
					if(w_hand === getweapon(#"hash_57feb2fb3f73d361"))
					{
						var_f5716a6 = 2;
						var_64d8621e = 2;
					}
					...
					{
						if(w_hand === getweapon(#"hash_31785bdec07e2919"))
						{
							var_f5716a6 = 3;
							var_64d8621e = 2;
						}
							...
							else
							{
								...
								else
								{
									...
									else
									{
										...
										{
											if(w_hand === getweapon(#"hash_403bfa4250f7a743"))
											{
												var_f5716a6 = 0;
												var_64d8621e = 7;
											}
											...
											{
												if(w_hand === getweapon(#"hash_6fed6a04129cb670"))
												{
													var_f5716a6 = 1;
													var_64d8621e = 7;
												}
												...
												{
													if(w_hand === getweapon(#"hash_7d9d24e1aef966fc"))
													{
														var_f5716a6 = 2;
														var_64d8621e = 7;
													}
													else if(w_hand === getweapon(#"hash_508ba13614577e04"))
													{
														var_f5716a6 = 3;
														var_64d8621e = 7;
													}
...
function function_42afccbf(e_target, weapon = level.weaponnone, n_damage)
{
	if(e_target.archetype === #"zombie")
	{
		...
		{
			if(e_target istouching(vol_cliff))
			{
...
function function_6161ce9a(e_player)
{
	...
	{
		s_result = undefined;
		s_result = e_player waittilltimeout(20, #"hash_1b2c21ba7b18dbf9", #"hash_52d2f17ac6d67de2", #"hash_4969a839c4e666dc", #"hash_39bd256a221ddf79", #"death");
	}
...
function function_530d7ea0(var_bcf66490, e_player)
{
	...
	{
		if(isdefined(self.var_f94ca998))
		{
