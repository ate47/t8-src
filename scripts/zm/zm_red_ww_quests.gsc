...
function init()
{
	...
	namespace_617a54f4::function_d8383812(#"hash_4764f31fcd0921a1", 16000, "ww_sc_g", &is_soul_capture, &soul_captured, 1);
	namespace_617a54f4::function_d8383812(#"hash_582081478b010fab", 16000, "ww_sc_c", &is_soul_capture, &soul_captured, 1);
	namespace_617a54f4::function_d8383812(#"hash_6d42bef9e51fa3a1", 16000, "ww_sc_h", &is_soul_capture, &soul_captured, 1);
	namespace_617a54f4::function_d8383812(#"hash_241d4655c7d78e9", 16000, "ww_sc_o", &is_soul_capture, &soul_captured, 1);
...
function function_841236e4(w_weapon, var_b6bc44ed)
{
	...
	{
		if(w_weapon.name === #"ww_hand_c_uncharged" || w_weapon.name === #"ww_hand_c" || w_weapon.name === #"ww_hand_c_upgraded")
		{
		...
		{
			if(w_weapon.name === #"ww_hand_o_uncharged" || w_weapon.name === #"ww_hand_o" || w_weapon.name === #"ww_hand_o_upgraded")
			{
				var_caa76b60 = #"air";
			}
	...
	if(idamage >= self.health || level flag::get("round_reset"))
	{
		...
		else
		{
			...
			else
			{
				...
				{
					if(self function_996fee51() === getweapon(#"ww_hand_c_uncharged"))
					{
...
function function_f25f67a7()
{
	...
	else
	{
		if(isdefined(w_hand))
		{
			...
			{
				if(w_hand === getweapon(#"ww_hand_c_uncharged"))
				{
					var_f5716a6 = 1;
					var_64d8621e = 2;
				}
				...
				{
					if(w_hand === getweapon(#"ww_hand_g_uncharged"))
					{
						var_f5716a6 = 2;
						var_64d8621e = 2;
					}
					...
					{
						if(w_hand === getweapon(#"ww_hand_o_uncharged"))
						{
							var_f5716a6 = 3;
							var_64d8621e = 2;
						}
							...
							else
							{
								...
								else
								{
									...
									else
									{
										...
										{
											if(w_hand === getweapon(#"ww_hand_h_upgraded"))
											{
												var_f5716a6 = 0;
												var_64d8621e = 7;
											}
											...
											{
												if(w_hand === getweapon(#"ww_hand_c_upgraded"))
												{
													var_f5716a6 = 1;
													var_64d8621e = 7;
												}
												...
												{
													if(w_hand === getweapon(#"ww_hand_g_upgraded"))
													{
														var_f5716a6 = 2;
														var_64d8621e = 7;
													}
