...
function function_7e94450c()
{
	...
	t_damage delete();
	self notify(#"hash_6858bc0ef6a5b4b1", {#hash_2db8b01a:e_brick.scene_ents[#"prop 1"], #e_player:e_player});
}
...
function function_9fe8bfeb()
{
	/#
		...
		a_players[0] notify(#"seedling_dropped", {#str_result:""});
	#/
}
...
function function_4594e669()
{
	/#
		...
		s_spawn = struct::get("");
		ai_zombie = zombie_utility::spawn_zombie(array::random(level.zombie_spawners), undefined, s_spawn);
		ai_zombie val::set(#"ww_quests_ignoreall", "", 1);
	#/
}
