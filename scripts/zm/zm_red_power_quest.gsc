...
function function_bda82828()
{
	...
	{
		player thread zm_vo::function_8e0f4696(#"hash_33e1e5be84d42bba", 0, 1, 9999, 1, 1, 1);
	}
...
function function_e059d0e1()
{
		...
		foreach(vol in var_a6c6bf68)
		{
			foreach(player in getplayers())
			{
				if(player istouching(vol) && (!(isdefined(player.var_e17ca454) && player.var_e17ca454)))
				{
					...
					s_nudge = arraygetclosest(player.origin, var_d11f336d);
	...
	{
		foreach(s_nudge in var_d11f336d)
		{
...
function reinforcements_think(var_17e78c4a, var_f153be86 = 0, var_a294702 = 0)
{
	...
	a_s_spawns = struct::get_array(var_17e78c4a);
	var_8e8ab42 = array::randomize(a_s_spawns);
	while(true)
	{
...
/*
	Name: registerpromenade_chillout_props_traversal
	Namespace: zm_red_power_quest
	Checksum: 0xD82342AB
	Offset: 0x7DB0
	Size: 0xD4
