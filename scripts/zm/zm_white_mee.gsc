...
function function_ec9e5cf2()
{
	...
	zm_sq::register(#"hash_104f80e15d623b58", #"step_1", #"hash_4fa5474cce491e7a", &function_ec78c3ce, &function_99e0948b);
	...
	zm_sq::register(#"hash_1e9936918d3e7bdd", #"step_1", #"hash_302164323de8aeff", &function_c5265b, &function_2dea6f24);
	level flag::init("mee_galvaknuckle_count_reached");
	zm_sq::register(#"hash_3eeb31180b204955", #"step_1", #"hash_24b97ea56a2b24c7", &function_ca6ddaed, &function_a2c337dc);
	level flag::init("mee_mixed_count_reached");
	zm_sq::register(#"hash_638821b038a894ea", #"step_1", #"hash_637cb3437044e304", &function_af78658, &function_af4d3b51);
