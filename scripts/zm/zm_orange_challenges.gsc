...
function function_d3fc7131()
{
	...
	switch(self.script_location)
	{
		...
		case "specimen_storage":
		{
			...
			self.var_12080390[self.var_12080390.size] = init_challenge(14, 10, 15, #"hash_6ded95ee1bc9540c", &registersplicestarttraverse, &function_7d030c3d, "hero_weapon_power", #"hash_697d3cc07f8424da");
...
function function_76007e28()
{
	...
	if(isdefined(var_d6578e1f) && isdefined(n_current_progress) && isdefined(n_index) && isdefined(n_goal))
	{
		...
		level namespace_6747c550::function_7df6bb60(#"zm_orange_challenges", n_index, self);
		switch(n_index)
		{
			case 4:
			case 12:
...
function function_2ae162bf()
{
	...
	var_d6578e1f = self.var_d6578e1f;
	foreach(s_ingredient in var_d6578e1f.var_607e76b3)
	{
...
function function_dfeb1c1b()
{
	...
	foreach(s_ingredient in self.var_607e76b3)
	{
...
function function_48f86741(var_d6578e1f)
{
	...
	while(true)
	{
		s_params = undefined;
		s_params = self waittill(#"damage");
		if(zm_orange_util::function_fe8ee9f0(s_params.weapon) && !level flag::get(#"hash_743092bcb25effda"))
		{
			var_d6578e1f.n_current_progress++;
			var_d6578e1f function_544b63c0(var_d6578e1f.n_current_progress);
			if(var_d6578e1f.n_current_progress >= var_d6578e1f.n_goal)
...
function function_bce7e59b(n_index, n_current_progress, n_goal)
{
	foreach(e_player in getplayers())
	{
		...
		level namespace_6747c550::function_7df6bb60(#"zm_orange_challenges", n_index, e_player);
	}
}
...
function function_fd8a137e(n_time = 0)
{
	...
	foreach(e_player in getplayers())
	{
		level namespace_6747c550::function_7df6bb60(#"zm_orange_challenges", 0, e_player);
