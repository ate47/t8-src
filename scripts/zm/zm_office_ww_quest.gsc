...
function function_3410748f()
{
	...
	function_a4121dfa();
	waitframe(1);
	level.s_code_drawer.var_d1cdd613 moveto(level.s_code_drawer.var_d1cdd613.origin + (-3.5, 13, 0), 0.3);
	...
	playsoundatposition(#"hash_7c109876c748f07c", level.s_code_drawer.var_d1cdd613.origin);
