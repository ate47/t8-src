...
function init_clientfields()
{
	...
	clientfield::register("scriptmover", "" + #"hash_599b6bf8d2df1c68", 1, getminbitcountfornum(9), "int");
	...
	clientfield::register("toplayer", "" + #"hash_2bde374c37c3f679", 1, 1, "int");
...
{
	zm_sq::register(#"main_quest", #"step_1", #"hash_631569eef3a5b030", &function_e3163424, &function_c4bd3743);
	zm_sq::register(#"main_quest", #"step_2", #"hash_63156ceef3a5b549", &function_fbba6b79, &function_eb027eca);
	zm_sq::register(#"main_quest", #"step_3", #"hash_63156beef3a5b396", &function_558b4527, &function_34f97128);
	zm_sq::register(#"main_quest", #"step_4", #"hash_63156eeef3a5b8af", &function_73a32bb4, &function_ba182aaa);
	zm_sq::register(#"main_quest", #"step_5", #"hash_63156deef3a5b6fc", &function_1b44fb7f, &function_92cd9426);
	zm_sq::register(#"main_quest", #"step_6", #"hash_631570eef3a5bc15", &function_443b1ad2, &function_542127b2);
	zm_sq::register(#"main_quest", #"step_7", #"hash_63156feef3a5ba62", &function_8ec70b18, &function_71a8bce1);
	zm_sq::register(#"main_quest", #"step_8", #"hash_631572eef3a5bf7b", &function_5b7a1511, &function_98cdd988);
	zm_sq::register(#"main_quest", #"step_9", #"hash_631571eef3a5bdc8", &function_f4b715c1, &function_b4d0381e);
	zm_sq::register(#"main_quest", #"outro_igc", #"hash_3130108028a1000", &function_594ebc75, &function_60d50c62, 1, &function_48837477);
}
...
function function_91be5845()
{
	...
	foreach(s_spark in level.var_a0a9b19d)
	{
...
function function_e3163424(var_5ea5c94d)
{
	...
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 1);
	if(!var_5ea5c94d)
	{
...
{
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 2);
	if(!var_5ea5c94d)
	{
...
function function_23153807(var_428229d6, var_3d89d732 = var_428229d6.var_3d89d732, var_d0b3106f = undefined)
{
	...
	{
		if(var_428229d6.var_e9af6526 == 7)
		{
			if(!isdefined(var_d0b3106f))
			{
...
{
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 4);
	function_ce111e55();
	/#
		if(getdvarint(#"hash_7919e37cd5d57659", 0))
		{
...
function function_40744a4()
{
	...
	var_b7855942 = array(#"transform1", #"transform2", #"transform3", #"transform4", #"transform1", #"transform2", #"transform3", #"transform4");
...
function function_e7615c8c()
{
	...
	for(i = 0; i < n_players; i++)
	{
		...
		if(isdefined(var_ab2645b))
		{
			...
			var_8e350fd9++;
			var_ab2645b waittilltimeout(var_475e440c * var_8e350fd9, #"death");
		}
	}
...
function function_ab15557a()
{
	...
	function_a5946754(a_spawnpoints, n_spawns * 0.6, var_7d847dee, 15, #"transform2", n_spawn_delay);
	wait(4);
	level thread spawn_blightfather();
	function_a5946754(a_spawnpoints, n_spawns * 0.4, var_7d847dee, 15, #"transform2", n_spawn_delay * 0.6);
	level notify(#"hash_215a84542b11208c");
	if(n_players > 2)
	{
		level thread spawn_blightfather();
...
/*
	...
	Flags: Linked
*/
function function_a5946754(a_spawnpoints, n_spawns, var_7d847dee = 24, var_4309d73b, var_e7c7eaab, n_spawn_delay = 0.1, var_70f72ba4 = 0.1)
{
	var_cbdd8fe5 = 0;
...
{
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 5);
	if(!var_5ea5c94d)
	{
		/#
...
function function_e81d23de()
{
	...
	var_250390bc = [];
	foreach(s_pipe in var_4b7c73c8)
	{
...
{
	level namespace_6747c550::function_7df6bb60(#"hash_588e00046665bac6", 1);
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 6);
	/#
		if(getdvarint(#"hash_7919e37cd5d57659", 0))
		{
			level flag::set(#"hash_76dd603f61fa542d");
...
{
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 7);
	/#
		if(getdvarint(#"hash_7919e37cd5d57659", 0))
		{
			gear_up();
...
function function_204d58b0(s_spawn_point, n_round_number)
{
	...
	var_b9a803af zm_transform::function_bbaec2fd();
...
{
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 8);
	if(!var_5ea5c94d)
	{
		function_9003b2d4();
		function_7b4cd474();
...
{
	level namespace_6747c550::function_7df6bb60(#"hash_5d7e4ccce97334e0", 9);
	...
	if(isdefined(s_portal.var_94b03771))
	{
		...
		while(1 && isdefined(s_portal.var_94b03771))
		{
			...
			if(s_portal.var_94b03771.var_22763205 === 1)
			{
				...
				{
					if(s_portal.var_94b03771.model !== #"p8_zm_zod_teleport_symbol")
					{
						s_portal.var_94b03771 setmodel(#"p8_zm_zod_teleport_symbol");
