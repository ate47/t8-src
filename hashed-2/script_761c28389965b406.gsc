...
function function_b01adb59()
{
	...
	if(isdefined(getgametypesetting(#"hash_3083d02ea0f5761c")) && getgametypesetting(#"hash_3083d02ea0f5761c"))
	{
		...
		wz_common_fixup::item_replacer(var_b5014996, var_f8a4c541, #"hash_610716711c6bf258", #"hash_74cdb6ca983d3aca");
		wz_common_fixup::item_replacer(var_b5014996, var_f8a4c541, #"hash_3f8034fc64c31ee1", #"hash_797c130a680817a3");
		wz_common_fixup::item_replacer(var_b5014996, var_f8a4c541, #"hash_60da8dc472901c8d", #"hash_33c658398f3aa905");
		wz_common_fixup::item_replacer(var_b5014996, var_f8a4c541, #"equipment_list_zombie", #"hash_1985194fedbf5145");
		wz_common_fixup::item_replacer(var_b5014996, var_f8a4c541, #"hash_25fc1eba4e8349b", #"hash_3b57a72645fe6d33");
		wz_common_fixup::item_replacer(var_f8a4c541, undefined, #"hash_5d3928f724e1cadf", #"hash_22b2e7dbec67dd6f");
		wz_common_fixup::item_replacer(var_f8a4c541, undefined, #"hash_4bfbb656e63b17ae", #"hash_68edd805f8bad724");
		wz_common_fixup::item_replacer(var_f8a4c541, undefined, #"hash_774a49591e12d6d", #"hash_6843501c099865b");
		wz_common_fixup::item_replacer(var_f8a4c541, undefined, #"hash_53568e2a0a929c12", #"hash_7e5f4822b2b5e4c0");
		wz_common_fixup::item_replacer(var_f8a4c541, undefined, #"hash_4be238cfa4c911b7", #"hash_7854b89f632d51b7");
		wz_common_fixup::item_replacer(var_f8a4c541, undefined, #"hash_58959191442a7ad4", #"hash_46aab46da9f75b03");
	}
