...
{
	system::register(#"hash_4d14e34831830ee6", &__init__, &__main__, undefined);
}
...
function private __init__()
{
	...
	if(getdvarint(#"hash_4cfef227405e3c46", 0) || getdvarint(#"hash_6e86098ccb2a7c2b", 0))
	{
...
function function_68cc8bce(params)
{
	...
	owner endon(#"death");
	turret endon(#"death");
	slots = namespace_b912c30b::function_bdb2b85b(turret, turret.origin, turret.angles, 30, 4, 300);
...
function function_ff5fd6b8(params)
{
	...
	if(isdefined(turret.var_b79a8ac7) && isdefined(turret.var_b79a8ac7.slots))
	{
		foreach(slot in turret.var_b79a8ac7.slots)
		{
			...
			{
				namespace_b912c30b::function_2b925fa5(slot.entity);
			}
		}
...
{
	self.var_37f16e2e = ispointonnavmesh(self.origin, self getpathfindingradius() / 1.0125);
	if(isdefined(self.var_4dc5382f) || (isdefined(self.var_37f16e2e) && self.var_37f16e2e))
	{
		return true;
	}
	return false;
...
{
	/#
		if(getdvarint(#"hash_4cfef227405e3c46", 0) || (!(isdefined(level.var_e066667d) && level.var_e066667d)))
		{
			return;
		}
...
{
	position = getclosestpointonnavmesh(self.origin - vectorscale((0, 0, 1), 100), 100, var_fab0ffd6);
	...
	{
		position = getclosestpointonnavmesh(self.origin - vectorscale((0, 0, 1), 100), 200, var_fab0ffd6);
		if(isdefined(position))
		{
			player_position = self.origin + vectorscale((0, 0, 1), 20);
			var_f5df51f2 = position + vectorscale((0, 0, 1), 20);
...
function private function_c75fae30(einflictor, eattacker, idamage, idflags, smeansofdeath, weapon, vpoint, vdir, shitloc, psoffsettime, damagefromunderneath, modelindex, partname)
{
	...
	#/
	if(getdvarint(#"hash_4cfef227405e3c46", 0) || getdvarint(#"hash_6e86098ccb2a7c2b", 0) && isdefined(weapon) && (!isdefined(weapon.statname) || (weapon.statname !== #"melee_bowie" && weapon.statname !== #"hatchet")) && !isdefined(self.enemy_override) && !isdefined(self.favoriteenemy) && isdefined(eattacker) && isplayer(eattacker))
	{
...
function private function_e91d8371(entity)
{
	...
	if(getdvarint(#"hash_4cfef227405e3c46", 0) || getdvarint(#"hash_6e86098ccb2a7c2b", 0) && (isdefined(entity.var_f9a12c59) && entity.var_f9a12c59))
	{
...
function private zombieshouldmelee(entity)
{
	...
	if(!namespace_b912c30b::is_player_valid(entity.enemy) && !function_f41ded83(entity.enemy))
	{
		return false;
	}
	...
	if(!function_f41ded83(entity.enemy) && (isdefined(self.var_37f16e2e) && self.var_37f16e2e) && !tracepassedonnavmesh(entity.origin, (isdefined(entity.enemy.enemy.last_valid_position) ? entity.enemy.last_valid_position : entity.enemy.origin), entity.enemy getpathfindingradius()))
	{
		return false;
	}
	entity.idletime = gettime();
...
function private function_860d5d8(entity)
{
	...
	{
		if(getdvarint(#"hash_4cfef227405e3c46", 0) == 1 && (gettime() - entity.idletime) < 1700)
		{
			return;
		}
...
function function_e261b81d()
{
	...
	{
		self namespace_b912c30b::function_55625f76(self.origin, self.angles, self.spawn_anim);
	}
	waitframe(1);
	self.aistate = 1;
	...
	while(true)
	{
		self.var_37f16e2e = ispointonnavmesh(self.origin, self getpathfindingradius() / 1.0125);
		self.var_6e3313ab = 0;
		if(isdefined(self.var_4dc5382f) && self istouching(self.var_4dc5382f.def))
		{
			self.var_6e3313ab = 1;
		}
		if(getdvarint(#"hash_4cfef227405e3c46", 0) == 1 || getdvarint(#"hash_6e86098ccb2a7c2b", 0) && !isdefined(self.var_4dc5382f))
		{
			self.var_6e3313ab = 1;
		}
		...
		#/
		if(!self.var_6e3313ab || (!self.var_37f16e2e && self.allowoffnavmesh))
		{
			if(!isdefined(self.var_6bcb6977))
			{
				self.var_6bcb6977 = gettime();
				if(isdefined(self.var_4dc5382f) && isdefined(self.var_4dc5382f.var_2209cb79))
				{
		...
		if(self.aistate == 3)
		{
			...
			{
				self.clamptonavmesh = !self.var_37f16e2e && isdefined(self.var_4dc5382f) && self istouching(self.var_4dc5382f.def);
			}
		}
		else
		{
...
function private function_eea7a68a(entity)
{
	...
	if(isdefined(entity.enemy_override))
	{
		namespace_b912c30b::function_2b925fa5(entity);
	}
	else if(!isdefined(entity.attackable))
	{
		entity.attackable = namespace_b912c30b::get_attackable(entity, 1);
	}
	if(isdefined(entity.current_state) && isdefined(entity.current_state.var_1bef5880))
	{
		[[entity.current_state.var_1bef5880]](entity);
	}
}
...
function function_83baeaf1(event)
{
	...
	{
		ai callback::callback(#"hash_184965470b4be191", {#params:event.params, #position:event.position, #entity:event.entity});
	}
}
...
{
	function_dad6ba0e(#"wander", &function_7c178619, &function_e5e48edb, &function_b333396b, undefined, &function_81c2c3d5);
...
function function_9d0a9f4e(entity, var_49413202)
{
	...
	{
		if(distancesquared(entity.var_b4b8ad5f.position, var_49413202.position) <= (64 * 64))
		{
			return false;
		}
	}
...
{
	entity namespace_b912c30b::function_9758722("walk");
	entity.favoriteenemy = undefined;
	entity thread function_76f8bf36(entity);
	entity callback::function_d8abfc3d(#"hash_184965470b4be191", &function_16b8d0ed);
}
...
/*
	...
	Flags: Linked, Private
*/
function private function_e5e48edb(entity)
{
	if(isdefined(entity.enemy))
	{
...
{
	entity callback::function_52ac9652(#"hash_184965470b4be191", &function_16b8d0ed);
}
...
function private function_7bc06e07(entity)
{
	if(entity.archetype === #"zombie")
	{
		...
		if(n_random < 33)
		{
			entity namespace_b912c30b::function_9758722("sprint");
		}
		else
		{
			if(n_random < 66)
			{
				entity namespace_b912c30b::function_9758722("super_sprint");
			}
			else
			{
				entity namespace_b912c30b::function_9758722("super_super_sprint");
			}
		}
	}
	else
	{
		entity namespace_b912c30b::function_9758722("run");
	}
	entity.var_b4b8ad5f = undefined;
...
function function_41dc2cb0()
{
	...
	if(isdefined(self.spawn_anim) && (isdefined(self.var_b8c61fc5) && self.var_b8c61fc5))
	{
		self namespace_b912c30b::function_55625f76(self.origin, self.angles, self.spawn_anim, self.var_16dd87ad);
	}
	waitframe(1);
	self.aistate = 1;
	self setgoal(self.origin);
...
function private function_bf21ead1()
{
	...
	else
	{
		if(!isdefined(self.attackable))
		{
			self.attackable = namespace_b912c30b::get_attackable(self);
		}
		var_293b2af1 = undefined;
		if(isinarray(level.var_8de0b84e, self getentitynumber()))
		{
			var_293b2af1 = namespace_b912c30b::ai_wz_can_see();
		}
		...
		{
			if(self namespace_b912c30b::function_f10600c(self.favoriteenemy))
			{
				self.var_bb185cc5 = gettime();
			}
			if((gettime() - self.var_bb185cc5) > 8000 || !namespace_b912c30b::is_player_valid(self.favoriteenemy))
			{
				self.favoriteenemy = undefined;
			}
		}
...
function private function_b8eff92a(state)
{
	switch(state)
	{
		case 1:
		{
			...
			{
				move_speed = "sprint";
				if(getdvarint(#"hash_4cfef227405e3c46", 0) == 1)
				{
					move_speed = "super_sprint";
				}
				self namespace_b912c30b::function_9758722(move_speed);
			}
			else
			{
				self namespace_b912c30b::function_9758722("walk");
		...
		case 3:
		{
			...
			if(isdefined(self.var_4dc5382f))
			{
				namespace_bf3feaf0::function_769a0b3f(self.var_4dc5382f, self);
			}
			break;
		}
		case 5:
...
function private function_36151fe3()
{
	...
	{
		if(isdefined(self.favoriteenemy.last_valid_position) && (isdefined(self.var_4dc5382f) && (isdefined(self.var_4dc5382f.var_36a9f8ba) && self.var_4dc5382f.var_36a9f8ba) || self.favoriteenemy.var_4dc5382f === self.var_4dc5382f))
		{
	...
	{
		if(self.var_37f16e2e && isdefined(self.attackable) && isdefined(self.var_b238ef38) && (self.var_b238ef38.slot.var_bb075e37 || (isdefined(self.var_b238ef38.slot.var_acdc8d71) && !self isingoal(self.var_b238ef38.slot.var_acdc8d71))))
		{
			if(!isinarray(level.var_8de0b84e, self getentitynumber()))
			{
				return;
		...
		else if(isdefined(self.var_b238ef38) && (self isatgoal() || !self.var_37f16e2e))
		{
			self function_d1e55248(#"hash_6e6d6ff06622efa4", 1);
			self pathmode("dont move", 1);
...
{
	if(!isdefined(self.var_9a79d89d) && isdefined(self.var_4dc5382f) && isdefined(self.var_4dc5382f.spawn_points) && self.var_4dc5382f.spawn_points.size > 0)
	{
	...
	else if(getdvarint(#"hash_4cfef227405e3c46", 0) == 1 || getdvarint(#"hash_6e86098ccb2a7c2b", 0) && !isdefined(self.var_9a79d89d) && !isdefined(self.var_4dc5382f))
	{
		self thread function_d4f2933d();
	}
	if(isdefined(level.var_3140c814) && level.var_3140c814 && (isdefined(self.var_721a3dbd) && self.var_721a3dbd))
	{
		if(!self.var_37f16e2e && !self function_dd070839())
		{
	...
	if(isdefined(self.var_5ed989c7) && self.var_5ed989c7)
	{
		if(isdefined(self.var_31a789c0) && self.var_31a789c0 && (isdefined(self.var_db912cfe) && self.var_db912cfe))
		{
			...
			{
				if(isdefined(players[i].var_4dc5382f) && players[i].var_4dc5382f === self.var_4dc5382f)
				{
...
function private function_af47322e()
{
	...
	while(true)
	{
		self.var_9a79d89d = self.var_4dc5382f.spawn_points[self.var_4dc5382f.var_96d81013].origin;
		self.var_4dc5382f.var_96d81013++;
		if(self.var_4dc5382f.var_96d81013 >= self.var_4dc5382f.spawn_points.size)
		{
			self.var_4dc5382f.var_96d81013 = 0;
		}
		if(isdefined(self.var_9a79d89d))
		{
			self.var_80780af2 = self.var_9a79d89d;
...
function private function_936718a8()
{
	...
	if(isdefined(self.favoriteenemy))
	{
		...
		var_e66d74ef = vectornormalize(vec_to_enemy);
		self.angles_to_enemy = vectortoangles(var_e66d74ef);
...
function private function_bfc25c77(entity)
{
	...
	{
		var_99b5fc08 = function_c79d31c4(startnode.targetname);
		if(isdefined(var_99b5fc08) && var_99b5fc08.size > 0)
		{
			entity.var_99b5fc08 = var_99b5fc08;
			return true;
		}
	}
	return false;
...
{
	if(isdefined(self.var_99b5fc08) && self.var_99b5fc08.size > 0)
	{
		var_9b1a1b39 = 1;
		foreach(dynent in self.var_99b5fc08)
		{
			damage = 10;
...
function private function_fee7d867(entity, asmstate)
{
	...
	if(isdefined(entity.var_99b5fc08))
	{
		foreach(dynent in entity.var_99b5fc08)
		{
...
function zombie_death_event(params)
{
	...
	if(isdefined(self.var_4dc5382f) && (isdefined(self.var_4dc5382f.var_78823914) && self.var_4dc5382f.var_78823914))
	{
		if(isdefined(self.var_1e9a96f7) && self.var_1e9a96f7 && isdefined(self.var_4dc5382f))
		{
			self.var_4dc5382f thread namespace_bf3feaf0::function_3effc794(self);
		}
		else
		{
			self.var_4dc5382f.var_78823914 = 0;
			self.var_4dc5382f thread namespace_bf3feaf0::function_1992880a();
		}
	}
	...
	if(isdefined(self.var_4dc5382f) && isplayer(e_attacker))
	{
		self.var_4dc5382f.var_f2fb3bb7 = e_attacker;
	}
}
...
function function_4346d61d(str_zone)
{
	...
	while(true)
	{
		e_player = namespace_b912c30b::get_closest_player(str_zone, self.origin);
