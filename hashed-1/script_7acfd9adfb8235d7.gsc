...
function function_aa79a199(var_a276c861)
{
	if(!var_a276c861)
	{
		...
		else
		{
			...
			level.var_a91e1dd1 thread mansion_pap::function_c9c7a593();
...
function function_4802a272()
{
	...
	{
		var_80296afc zm_vo::function_8e0f4696(var_bfe15d00, 0, 1, 9999);
...
function function_79556c43(var_80296afc, var_5e246f88)
{
	if(isalive(var_80296afc))
	{
		...
		foreach(var_e5e56c3d in var_5e243806)
		{
			...
			{
				var_e5e56c3d thread zm_vo::function_8e0f4696(var_5e246f88, 0, 1, 9999, 1, 1);
			}
		}
		if(var_80296afc function_188bb878(var_5e246f88))
		{
			var_80296afc zm_vo::function_8e0f4696(var_5e246f88, 0, 1, 9999, 1, 1);
		}
	}
}
...
function function_9ee098d5()
{
	...
	while(var_ac3fdee1 < 4)
	{
		...
		v_drop = mansion_util::function_a8176b98(var_6a991844);
		if(isdefined(v_drop))
		{
			switch(var_ac3fdee1)
			{
...
function function_e7423237()
{
	...
	wpn_betty_explo_vox clientfield::set("" + #"hash_338e6c710a21b0c", 1);
