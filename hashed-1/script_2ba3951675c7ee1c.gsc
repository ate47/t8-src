...
function function_842d114a(player)
{
	...
	if(player hasweapon(getweapon(#"ww_blundergat_t8")) || player hasweapon(getweapon(#"hash_cb1cdb5b47f0226")) || player hasweapon(getweapon(#"hash_25a13b6f6232a985")) || player hasweapon(getweapon(#"hash_4c157b1aeefae09e")) && !isdefined(self.stub.var_bd8af718))
	{
		...
		else
		{
			...
			{
				if(player hasweapon(getweapon(#"hash_25a13b6f6232a985")))
				{
					if(function_8b1a219a())
					{
...
function function_d74a3faf(e_player)
{
	...
	{
		if(e_player hasweapon(getweapon(#"hash_cb1cdb5b47f0226")))
		{
...
/*
	...
	Flags: Linked
*/
function function_599013ad(e_player, turret_hallway_front_door_tank_)
{
	...
	if(isdefined(self.var_607f49de))
	{
		if(isdefined(turret_hallway_front_door_tank_) && turret_hallway_front_door_tank_)
		{
...
function function_9689b55c(var_88f24b00)
{
	...
	while(true)
	{
		...
		if(isplayer(s_result.activator))
		{
			...
			{
				if(level.var_19a54d73 == (var_39662a63 * 2))
				{
