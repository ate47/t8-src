...
{
	system::register(#"hash_3c059795b5caee04", &init_shared, undefined, undefined);
}
...
{
	weaponobjects::function_e6400478(#"hash_661d3f578391fdda", &function_41625261, 1);
...
function function_5df80e43(watcher, player)
{
	...
	grenade_weapon = getweapon(#"hash_661d3f578391fdda");
